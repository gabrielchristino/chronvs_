...
try {
    ...
    & gcc -std=c11 -Wall -Wextra -Werror -I tests/aion_stubs -I src tests/aion_service_test.c src/services/aion_service.c src/core/calendar.c src/core/mnemo_text.c -o .pio/host-tests/aion_service_test.exe
